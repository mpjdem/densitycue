...
dat.fname = ['dat_practice_' dat.subj '.mat'];
...
if exist(dat.fname,'file')
    ...
    dat.cond_contdens(1:TRIALS_PER_BLOCK) = custom_randi(2,[1 TRIALS_PER_BLOCK]);
    dat.cond_contdens(TRIALS_PER_BLOCK+1:3*TRIALS_PER_BLOCK) = custom_randi(4,[1 2*TRIALS_PER_BLOCK]);
    dat.cond_contdens(3*TRIALS_PER_BLOCK+1:5*TRIALS_PER_BLOCK) = custom_randi(8,[1 2*TRIALS_PER_BLOCK]);
...
if dat.next_trial>1
    PTBtxt = 'Welcome back to the practice experiment! \n Press a button to continue.';
