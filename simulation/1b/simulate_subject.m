function simulate_subject(subj_n, sim_name, cld_params)
    ...
    subj_file = [basedir 'data' filesep '1b' filesep 'dat' num2str(subj_n) '.mat'];
    load(subj_file, 'dat');
    
    % Stimulus directory
    stimdir = [basedir 'experiment' filesep '1b' filesep 'stims' filesep];
    ...
    for trial = 1:trials_n
        ...
        if strcmp(cld_params.method_dens, 'RadCount')
%            cld_params.border_dist = mindist * max(or_rad) * 1.5;
            cld_params.rad = mindist * or_rad;
%         else
%             cld_params.border_dist = mindist * 2;
        end
