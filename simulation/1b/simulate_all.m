...
% AvgDist10
ad10_params = struct;
ad10_params.method_dens = 'AvgDist';
ad10_params.method_stat = 'MC';
ad10_params.mc_samples_n = 1000;
ad10_params.avg_n = 10;


% AvgDist15
ad15_params = struct;
ad15_params.method_dens = 'AvgDist';
ad15_params.method_stat = 'MC';
ad15_params.mc_samples_n = 1000;
ad15_params.avg_n = 15;
...
sims = {'AvgDist','AvgDist1','AvgDist2', 'AvgDist3','AvgDist4','AvgDist5','AvgDist10', 'AvgDist15',...
        'RadCountFull','RadCount125','RadCount15','RadCount175','RadCount2','RadCount225',...
        'Voronoi'};
sims_params = {ad_params, ad1_params, ad2_params, ad3_params, ad4_params, ad5_params, ad10_params, ad15_params,...
               rcf_params, rc125_params, rc15_params, rc175_params, rc2_params, rc225_params,...
               vor_params};
...
for i = 1:length(sims)
    ...
    if ~exist([sim_name filesep 'all.mat'], 'file')
        onebigfile([sim_name filesep], ['sim_' sim_name '_'], 800);
    end
